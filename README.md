...
- **Built-in nodes** — MIDI In/Out, Audio In/Out, MIDI Monitor, Audio Monitor (oscilloscope), MIDI Keyboard, UDP In/Out, OSC In/Out, ArtNet In/Out, DMX In/Out, DMX Monitor, DMX Console, ArtNet Monitor, ArtNet Console, OSC Monitor, UDP Monitor, MQTT Subscribe
...
│   ├── MqttDeviceNodes.h/.cpp       MQTT Subscribe (type 22) + MqttDeviceManager
...
*Patchy v0.0.895 — JUCE 8 · React 19 · ReactFlow · Vite · TypeScript · Lucide*
